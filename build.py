...
YOUTUBE_DOWNLOADER_LOGO = """
__     __  _____   _    _  _______  _    _  ____   ______            
 \ \   / / |_   _| | |  | ||__   __|| |  | ||  _ \ |  ____|     
  \ \ / /    | |   | |  | |   | |   | |  | || |_) || |__    
   \ V /     | |   | |  | |   | |   | |  | ||  _ < |  __|      
    | |      | |   | |__| |   | |   | |__| || |_) || |____    
    |_|      |_|    \____/    |_|    \____/ |____/ |______|   
                                                            
 _____    ___   __          __  _   _  _        _____         _____   ______  _____  
|  __ \  / _ \  \ \        / / | \ | || |      / ____|  /\   |  __ \ |  ____||  __ \ 
| |  | || | | |  \ \  /\  / /  |  \| || |     | |  __  /  \  | |  | || |__   | |__) |
| |  | || | | |   \ \/  \/ /   | . ` || |     | | |_ |/ /\ \ | |  | ||  __|  |  _  / 
| |__| || |_| |    \  /\  /    | |\  || |____ | |__| / ____ \| |__| || |____ | | \ \ 
|_____/  \___/      \/  \/     |_| \_||______| \_____/_/    \_\_____/ |______||_|  \_\
"""
...
def print_logo():
    print("\033[96m" + YOUTUBE_DOWNLOADER_LOGO + "\033[0m")
    print("\033[93m" + "Building YouTube Downloader...".center(56) + "\033[0m\n")
...
def build():
    ...
    spec_file = os.path.join("YouTubeDownloader.spec")
